    ...
    <section id="about" className="py-20">
      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <motion.div 
          ...
          className="md:w-1/3"
        >
          <img src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="EliTechWiz" className="rounded-full w-48 h-48 md:w-64 md:h-64 mx-auto object-cover shadow-lg border-4 border-blue-500/50" loading="lazy" />
        </motion.div>
        <motion.div 
