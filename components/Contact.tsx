  ...
  return (
    <section id="contact" className="py-12 sm:py-16 md:py-20">
      ...
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
        <p className="text-sm sm:text-base text-slate-500 dark:text-gray-400 mb-8 sm:mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-12">
            {CONTACT_INFO.map(({ Icon, label, value, href }) => (
                <a 
                    ...
                    className="group bg-slate-100 dark:bg-gray-950 p-4 sm:p-6 rounded-lg flex items-center space-x-3 sm:space-x-4 transition-all duration-300 hover:bg-slate-200 dark:hover:bg-gray-800 hover:shadow-lg hover:shadow-blue-500/10 border border-slate-200 dark:border-gray-900 hover:border-blue-500 transform hover:-translate-y-1"
                >
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-slate-500 dark:text-gray-400 text-left break-words">{value}</p>
                    </div>
                </a>
            ))}
        </div>
