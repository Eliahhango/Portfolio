    ...
    <section id="contact" className="relative overflow-hidden py-12 sm:py-16 md:py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="grid gap-8 xl:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[2rem] border border-slate-200 bg-white/90 p-6 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-slate-900/65 sm:p-8">
            <div className="space-y-4">
              <div className="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-5 dark:border-white/10 dark:bg-slate-800/70">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-blue-600 dark:text-blue-300">Email</p>
                    <a
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200/80 bg-white p-4 dark:border-white/10 dark:bg-slate-800/70">
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-700 dark:bg-white/10 dark:text-slate-200">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="mt-2 block text-sm font-semibold text-slate-900 transition hover:text-blue-600 dark:text-white dark:hover:text-blue-300"
                      >
                ...
                <div className="rounded-2xl border border-slate-200/80 bg-white p-4 dark:border-white/10 dark:bg-slate-800/70">
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-300">
              ...
              <div className="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-5 dark:border-white/10 dark:bg-slate-800/70">
                <div className="flex items-start gap-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-700 dark:bg-white/10 dark:text-slate-200">
                    <MapPin className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Location</p>
                    <p className="mt-2 text-base font-semibold text-slate-900 dark:text-white">Dar es Salaam, Tanzania</p>
                    <p className="mt-2 text-sm leading-7 text-slate-500 dark:text-slate-300">
              ...
              <div className="rounded-2xl border border-slate-200/80 bg-white p-5 dark:border-white/10 dark:bg-slate-800/70">
                <div className="flex items-start gap-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-blue-50 text-blue-600 dark:bg-blue-500/10 dark:text-blue-300">
            ...
            <div className="mt-6 flex flex-wrap gap-3 border-t border-slate-200/80 pt-5 dark:border-white/10">
